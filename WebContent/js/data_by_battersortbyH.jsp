...
try{
	...
	String sql = "select rank() over(order by sum(H) desc) as rank, player_name, team_name, round(sum(ab)/sum(h),3) AVG, sum(pa) PA, sum(ab) AB, sum(r) R, sum(h) H, sum(DOUBLE) DB, "
