...
<image align="center" alt = "SK" src="<%=request.getContextPath()%>/image/SK.png" width="100px" height="100px"/>
<a align = "center" data-tooltip-text = "D-AVG: day-average. 타율, PA: plate appearance. 타석, AB: at bat. 타수, R: run. 득점, H: hit. 안타, 
